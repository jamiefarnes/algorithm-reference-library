...
:py:mod:`wrappers.arlexecute.pipelines.pipeline_components.continuum_imaging_component` is itself assembled using the
:py:mod:`wrappers.arlexecute.execution_support.arlexecute.arlexecute.execute` function.

The functions for creating graphs are:

    - :py:mod:`wrappers.arlexecute.support_wrappers.imaging_workflows`: Graphs to perform various types of prediction and inversion of visibility data
    - :py:mod:`wrappers.arlexecute.image.generic_workflows`: Graphs to perform generic image operations
    - :py:mod:`wrappers.arlexecute.visibility.generic_workflows`: Graphs to perform generic visibility perations
    - :py:mod:`wrappers.arlexecute.simulation.simulation_workflows`: Graphs to support simulations
    - :py:mod:`wrappers.arlexecute.pipelines.pipeline_workflows`: Graphs to implement the canonical pipelines
